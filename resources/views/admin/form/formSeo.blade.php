...
{{-- ===== V3.1: Phiên bản dịch chuyển lên BANNER ĐẦU TRANG =====
     Trước đây panel "Phiên bản dịch" được nhúng dưới box SEO.
     Từ V3.1: language switcher hiển thị ở banner trên đầu trang admin
     (admin.snippets.translationOriginBanner — auto-inject qua View Composer).

     Việc loại bỏ panel ở đây giúp:
       - Tránh duplicate UI (banner trên + panel dưới)
       - Box SEO chỉ tập trung field SEO thuần (title/desc/seo_*/slug/...)
       - Switcher ngôn ngữ luôn ở vị trí cố định (sticky top), dễ truy cập
--}}