...
<!-- ===== Card Header ===== -->
<div class="titlePage">
    Danh sách Đối tác Combo
</div>
<!-- ===== START: SEARCH FORM ===== -->
<form id="formSearch" method="get" action="{{ route('admin.comboPartner.list') }}">
    <div class="searchBox">
                    ...
                    <tr id="item-{{ $item->id }}">
                        ...
                        <td style="vertical-align:top;display:flex;font-size:0.95rem;">
                            <div class="icon-wrapper iconAction">
                                <a href="{{ route('admin.comboPartner.view', ['id' => $item->id]) }}">
                                    <i data-feather='edit'></i>
                                    <div>Sửa</div>
                                </a>
                            </div>
                            <div class="icon-wrapper iconAction">
                                <a href="{{ route('admin.comboPartner.view', ['id' => $item->id, 'type' => 'copy']) }}">
...
<!-- Nút thêm -->
<a href="{{ route('admin.comboPartner.view') }}" class="addItemBox">
    ...
    <script type="text/javascript">
        function deleteItem(id){
            if(confirm('{{ config("admin.alert.confirmRemove") }}')) {
                $.ajax({
                    url         : "{{ route('admin.comboPartner.delete') }}",
                    type        : "GET",
                    dataType    : "html",
                    data        : { id : id }
                }).done(function(data){
