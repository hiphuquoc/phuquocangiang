        ...
        <div class="pageAdminWithRightSidebar withRightSidebar">
            ...
            <div class="pageAdminWithRightSidebar_main">
                ...
                <div class="pageAdminWithRightSidebar_main_content">
                    ...
                    {{-- Đã chuyển toàn bộ multilingual sang panel "Phiên bản dịch" trong formSeo
                         (xem snippet admin.snippets.translationStatusPanel) — kiến trúc V3.0:
                         mỗi ngôn ngữ là 1 trang dịch riêng (admin.translation.edit/{locale}/{seoId}). --}}
                    <div class="pageAdminWithRightSidebar_main_content_item">
                        <div class="card">
                            <div class="card-header border-bottom">
