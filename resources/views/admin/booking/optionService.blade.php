@if(!empty($options))
    <div class="optionListBox">
        @foreach($options as $item)
            <label class="optionListBox_item" for="option_{{ $item['id'] }}" onClick="loadFormQuantityByOptionService({{ $item['id'] }});">
                <div class="optionListBox_item_radio">
                    <div class="form-check form-check-info">
                        ...
                        @endphp
                        <input type="radio" id="option_{{ $item['id'] }}" name="service_option_id" value="{{ $item['id'] }}" class="form-check-input" {{ $checked }} />
                    </div>
                </div>
