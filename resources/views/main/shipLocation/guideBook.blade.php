@php
    $arrayData  = [
        0 => [
            ...
            'title'     => t('ship_guidebook_step1_title'),
            'content'   => t('ship_guidebook_step1_content')
        ],
        1 => [
            'img'       => '/storage/images/upload/huong-dan-dat-ve-tau-2-type-manager-upload.webp',
            'title'     => t('ship_guidebook_step2_title'),
            'content'   => t('ship_guidebook_step2_content')
        ],
        2 => [
            'img'       => '/storage/images/upload/huong-dan-dat-tour-3-type-manager-upload.webp',
            'title'     => t('ship_guidebook_step3_title'),
            'content'   => t('ship_guidebook_step3_content', ['brand' => config('company.sortname')])
        ],
        3 => [
            'img'       => '/storage/images/upload/huong-dan-dat-ve-tau-4-type-manager-upload.webp',
            'title'     => t('ship_guidebook_step4_title'),
            'content'   => t('ship_guidebook_step4_content')
        ]
    ]
@endphp    
