    ...
    <div class="bookFormSortHotel_top">
        <div class="bookFormSortHotel_top_item">
            <div class="inputWithLabelInside location">
                <label for="hotel_form_sort_location"><i class="fa-solid fa-location-dot"></i> {{ t('form_destination') }}</label>
    ...
    <div class="bookFormSortHotel_bottom">
        <div class="bookFormSortHotel_bottom_item">
            <div class="inputWithLabelInside date">
                <label class="maxLine_1" for="hotel_form_sort_check_in"><i class="fa-regular fa-calendar-days"></i> {{ t('form_check_in') }}</label>
            ...
            <div class="inputWithLabelInside night">
                <label for="hotel_form_sort_quantity"><i class="fa-solid fa-moon"></i> {{ t('hotel_night_count') }}</label>
