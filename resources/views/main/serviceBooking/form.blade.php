...
@section('content')
    ...
    <form id="formBooking" action="{{ booking_route('serviceBooking.create') }}" method="POST">
    @csrf
                                        ...
                                        <div class="formColumnCustom">
                                            <div class="formColumnCustom_item">
                                                <div class="inputWithLabelInside location">
                                                    <label class="form-label" for="service_location_id">{{ t('booking_destination') }}</label>
                                            ...
                                            <div class="formColumnCustom_item">
                                                <div class="inputWithLabelInside">
                                                    <label class="form-label" for="service_info_id">{{ t('booking_choose_service') }}</label>
    ...
    <script type="text/javascript">
        ...
        function loadOptionService(){
            ...
            if(date!=''&&idServiceInfo!=''){
                $.ajax({
                    url         : '{{ booking_route("serviceBooking.loadOption") }}',
                    type        : 'get',
                    dataType    : 'html',
                    data        : {
                        service_info_id         : idServiceInfo,
        ...
        function loadFormQuantityByOption(){
            ...
            $.ajax({
                url         : '{{ booking_route("serviceBooking.loadFormQuantityByOption") }}',
                type        : 'get',
                dataType    : 'html',
                data        : {
        ...
        function loadBookingSummary(){
            ...
            $.ajax({
                url         : '{{ booking_route("serviceBooking.loadBookingSummary") }}',
                type        : 'get',
                dataType    : 'html',
                data        : {
                    dataForm    : dataForm
