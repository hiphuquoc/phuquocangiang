@php
    $arrayData  = [
        0 => [
            ...
            'content'   => t_raw('service_guidebook_step1_content'),
        ],
        1 => [
            ...
            'content'   => t_raw('service_guidebook_step2_content'),
        ],
        2 => [
            'img'       => '/storage/images/upload/huong-dan-dat-tour-3-type-manager-upload.webp',
            'title'     => t('service_guidebook_step3_title'),
            'content'   => t_raw('service_guidebook_step3_content', ['brand' => config('company.sortname')]),
        ],
        3 => [
            ...
            'content'   => t_raw('service_guidebook_step4_content'),
        ]
    ]
@endphp    
