...
class Kernel extends HttpKernel
{
     ...
     */
    /**
     * Laravel 9: chỉ đọc $routeMiddleware. Laravel 10+: $middlewareAliases (hoặc cả hai).
     * Giữ đồng bộ hai mảng để deploy không bị "Target class [detectLocale] does not exist"
     * khi hosting chưa chạy xong composer update.
     */
