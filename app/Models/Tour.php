...
class Tour extends Model {
    ...
    /** Cấu hình đa ngôn ngữ — đồng bộ với config/tablemysql.php tour_info.translatable */
    public string $translationModel    = TourTranslation::class;
    ...
    public function options(){
        return $this->hasMany(\App\Models\TourOption::class, 'tour_info_id', 'id')->whereNull('tour_option.language_id');
    }
