...
class RelationTourLocationDestinationList extends Model {
    use HasFactory;
    protected $table        = 'relation_tour_location_destination_list';
    protected $fillable     = [
        'tour_location_id', 
        'category_info_id'
    ];
    ...
    public static function insertItem($params){
        $id             = 0;
        if(!empty($params)){
            $model      = new RelationTourLocationDestinationList();
